...
>[!NOTE]
>
>Journey Optimizer B2B Edition följer syntaxen _kamelcase_ för personaliseringstoken i e-postmeddelanden för att matcha de andra Adobe Experience Platform-programmen för en enhetlig upplevelse. Detta tokenformat är helt kompatibelt med [Handlebars-mallsspråket](https://handlebarsjs.com/guide/#what-is-handlebars){target="_blank"}. Alla tokens som lades till före den här ändringen uppdateras automatiskt.

I följande exempel beskrivs stegen för att anpassa innehåll med hjälp av person- och systemtokens. Det återspeglar den aktuella Journey Optimizer B2B Edition-versionen.
