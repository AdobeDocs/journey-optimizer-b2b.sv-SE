...
1. Expandera avsnittet _[!UICONTROL Styles]_på den högra panelen med fliken **[!UICONTROL Border]**markerad och ange alternativen för att visa en kantlinje för komponenten:
...
Expandera avsnittet _[!UICONTROL Styles]_på den högra panelen med fliken **[!UICONTROL Size]**markerad och ange alternativen för komponentens höjd och bredd:
...
Expandera avsnittet _[!UICONTROL Styles]_på den högra panelen med fliken **[!UICONTROL Text]**markerad och ange alternativ för komponentens textformat:
...
## Aktiviteter för engagemangspoäng - Marketo {#engagement-activities-me}

| Aktivitetsnamn | Beskrivning | Maximalt antal dagliga frekvenser | Standardaktivitetsvikt för modell |
| --- | --- | --- | --- |
| [!UICONTROL Attend Event] | En medlem deltog i en händelse | 20 | 60 |
| [!UICONTROL Email Clicked] | En medlem klickar på en länk i ett e-postmeddelande | 20 | 30 |
| [!UICONTROL Email Opened] | En medlem öppnar ett mejl | 20 | 30 |
| [!UICONTROL Form Filled Out] | En medlem fyller i och skickar ett formulär på en webbsida | 20 | 40 |
| [!UICONTROL Interesting Moment] | En medlem har en intressant stund | 20 | 60 |
| [!UICONTROL Link Clicks] | En medlem klickar på en länk på en webbsida | 20 | 40 |
| [!UICONTROL Page Views] | En medlem visar en webbsida | 20 | 40 |
| [!UICONTROL Register for Event] | En medlem registrerad för en händelse | 20 | 60 |
