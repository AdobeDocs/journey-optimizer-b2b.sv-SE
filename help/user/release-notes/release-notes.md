...
| Funktion | Aktivera målgrupp för [!DNL Adobe Target] | Nu kan du aktivera en målgrupp från en kontoresa till en extern kundmålgrupp och skicka den [!DNL Adobe Target]. Med den här integreringen kan du leverera en målgrupp som är kvalificerad genom en färdssekvens för en webbupplevelse som är utformad i [!DNL Target]. [Läs mer](../audiences/target-external-audience.md) |
...
| Funktion | Flera Marketo Engage-aktiveringar | Konfigurera anslutningar till fjärrinstanser av Marketo Engage och använd dessa anslutningar för att konfigurera Marketo Engage-åtgärder för resor. Dessa åtgärder, som att lägga till eller ta bort personer från listor eller lägga till personer i en begärandekampanj, gäller för den angivna Marketo Engage-instansen. [Läs mer](../admin/marketo-actions-connect.md) |
