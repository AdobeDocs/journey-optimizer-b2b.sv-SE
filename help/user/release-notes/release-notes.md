...
| Funktion | Flera Marketo Engage-aktiveringar | Konfigurera anslutningar till fjärrinstanser av Marketo Engage och använd dessa anslutningar för att konfigurera Marketo Engage-åtgärder från resor. Dessa åtgärder, som att lägga till/ta bort personer från listor eller lägga till personer i en begärandekampanj, gäller för den angivna Marketo Engage-instansen. |
