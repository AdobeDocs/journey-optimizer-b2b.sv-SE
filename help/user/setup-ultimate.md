...
description: Konfigurera Journey Optimizer B2B Edition. Konfigurera XDM-scheman, e-post-/SMS-kanaler, Marketo Engage reseåtgärder och användare.
...
Adobe Journey Optimizer B2B Edition bygger på Adobe Experience Platform. I och med den här implementeringen finns Journey Optimizer B2B Edition och Marketo Engage inte i samma system och datalager. Journey Optimizer B2B Edition tar emot data från Adobe Experience Platform. Men man fortsätter att förlita sig på Marketo Engage-berättiganden och vissa backend-funktioner, som e-postleverans, för att etablera och konfigurera systemet.
...
Implementeringen är grunden som frigör funktioner i Journey Optimizer B2B Edition:

* **Gör era data enhetliga och skalbara enkelt:** Plattformen har stöd för komplexa datamodeller, inklusive anpassade objekt, inköpsgrupper och kontohändelser.
...
* **Skydda dina data:** Avancerade sekretess- och säkerhetsfunktioner som skyddar din kundinformation. (_Kommer snart_)

* **Skapad för framtiden:** Den här konfigurationen har stöd för pågående förbättringar och innovation.

Använd följande riktlinjer för konfiguration.

Använd checklistan för att slutföra installationen av Journey Optimizer B2B Edition.
...
Om du vill skicka e-postmeddelanden från [!DNL Journey Optimizer B2B Edition] konfigurerar du e-postspårning och -leverans i den bifogade [!DNL Marketo Engage]-produktionsinstansen och i [!DNL Journey Optimizer B2B Edition]-appen.
