...
1. Klicka på **[!UICONTROL Create brand]** längst upp till höger på sidan _[!UICONTROL Brands]_.
...
Publicerade varumärken är tillgängliga från alternativet **[!UICONTROL Brand]** i AI [varumärkesjusteringspoängen](./content-evaluation.md#brand-alignment-score) och [innehållsgenereringsverktygen](../ai-assistant/generative-ai-content.md).
