...
* **[!UICONTROL Buying group]** - Välj den [köpgruppsroll](../buying-groups/buying-groups-role-templates.md) som ska användas för ditt meddelande. [!DNL Journey Optimizer B2B Edition] erbjuder fem standardroller för B2B-inköpsgrupper direkt. Varje inköpsgruppsroll har ett tydligt meddelandefokus:
...
* **[!UICONTROL Generative model]**: Välj bland den färdiga Adobe-modellen, partnermodellen för specialiserade funktioner eller konfigurerade anpassade modeller som är anpassade efter ert varumärke. Mer information om generativa modeller finns i _[Generativa AI-modeller för varumärkesjustering](generative-ai-models.md)_.
...
![AI Assistant växlar i e-postdesignområdet](./assets/email-designer-ai-assistant-button.png){width="600" zoomable="yes"}
