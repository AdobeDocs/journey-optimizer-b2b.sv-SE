...
I [!DNL Journey Optimizer B2B Edition] kan storleken och mellanrummet för de olika elementen i ditt innehåll förfinas ytterligare med formatparametrarna och attributen i e-postrutan för Designer **[!UICONTROL Styles]**.
...
* Använd alternativet [Återgivning via e-post](email-test-rendering.md) som använder Litmus för att simulera dina designer för de vanligaste e-postklienterna (Apple Mail, Gmail, Outlook) och se om text, färger och bilder gör ditt innehåll tillgängligt. <!--Litmus includes accessibility testing-->
