...
>[!IMPORTANT]
>
>När kontoresan används i en annan resa från en _Utför en åtgärd_-nod med åtgärden _[!UICONTROL Add Account to (other) Journey]_&#x200B;och avbryter resan blockerar åtgärden i den resan.
...
>[!IMPORTANT]
>
>När kontoresan används i en annan resa från en _Utför en åtgärd_-nod med åtgärden _[!UICONTROL Add Account to (other) Journey]_&#x200B;och stänger den till nya poster blockerar åtgärden från den resan.
