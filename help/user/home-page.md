...
När du loggar in på Adobe Experience Platform och väljer appen Adobe Journey Optimizer B2B edition visas startsidan. Den här sidan innehåller en översikt över det aktuella läget för dina Journey Optimizer B2B-initiativ i form av <!-- refined insights and--> snabblänkar till de relevanta resurserna.
