...
Du kan ta bort ett inköpsgruppjobb genom att klicka på ellipsen (...) bredvid jobbnamnet och väljer **[!UICONTROL Delete]**.
...
1. Aktivera inställningen **[!UICONTROL Update existing buying groups]** (valfritt).
   ...
   När det här alternativet är aktiverat uppdateras alla befintliga inköpsgrupper i kombination med lösningsräntan via den dagliga synkroniseringscykeln.
...
1. Klicka på ellipsen på fliken _[!UICONTROL Solution interest]_(**...**) bredvid lösningsintresset och välj **[!UICONTROL Delete]**.
...
>[!VIDEO](https://video.tv.adobe.com/v/3450117/?captions=swe&learn=on)
