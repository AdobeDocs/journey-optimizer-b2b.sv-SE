...
description: Snabba upp arbetsflödena med AI Assistant - få produktkunskaper, felsökningshjälp och driftsinsikter för Journey Optimizer B2B edition.
...
>[!IMPORTANT]
>
>Du måste godkänna [användarriktlinjerna](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"} innan du kan använda AI Assistant i Journey Optimizer B2B edition. Avtalet innehåller även det allmänna betaavtalet så att du kan använda ytterligare AI-assistentfunktioner när de lanseras i en betapacitet.
...
| Destinationer | <li>Konfigurerade destinationsantal <li>Mål - målgruppsrelation <li>Destinationsattributrelation | <li>Kontoinställning <li>Autentiseringsinformation för konto <li>Unika profiler har aktiverats |
