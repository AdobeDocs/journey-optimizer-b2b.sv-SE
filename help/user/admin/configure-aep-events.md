...
När du väljer händelser för att uppnå dina organisatoriska mål bör du tänka på följande:
...
* Ni kan använda Experience Events för att fatta beslut inom en resa, men de behålls inte. Därför kan ni inte utnyttja tidigare erfarenheter av Experience Events inom Journey Optimizer B2B Edition.
...
1. Klicka på **[!UICONTROL XDM Classes]** på den mellanliggande panelen och klicka sedan på fliken **[!UICONTROL Events]** för att visa listan över tillgängliga händelser.
   ...
   Listan visas enligt kolumnen _[!UICONTROL Last update]_, med de senast uppdaterade händelserna högst upp som standard.
