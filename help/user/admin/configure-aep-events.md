...
* **_Schema_** - XDM-schema som definierar Experience Event-datastrukturen. Den måste baseras på en Experience Event och måste vara profilaktiverad.
  ...
  >[!NOTE]
  >
  >Samordna med konstruktörsteamet för att säkerställa att nödvändiga scheman är definierade. [Att skapa XDM-scheman](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/composition) är en komplex process som utförs av datatekniker baserat på ärendekrav i hela organisationen.
...
1. Välj **[!UICONTROL Event types]** som ska användas för händelsedefinitionen.
   ...
   De [händelsetyper](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/classes/experienceevent#eventType) som du väljer avgör vilka händelser som är tillgängliga som begränsningar för en _Lyssna efter en händelse_-nod i en kontoresa.
