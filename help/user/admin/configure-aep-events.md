...
Administratörer kan konfigurera Adobe Experience Platform (AEP)-baserade händelsedefinitioner, som gör att marknadsförare kan skapa kontoresor som reagerar på [AEP Experience Events](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/classes/experienceevent).
...
* **_Schema_** - XDM-schema som definierar Experience Event-datastrukturen. Den måste baseras på en Experience Event och måste vara profilaktiverad.
  ...
  >[!NOTE]
  >
  >Samordna med konstruktörsteamet för att säkerställa att nödvändiga scheman är definierade. [Att skapa XDM-scheman](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/schema/composition) är en komplex process som utförs av datatekniker baserat på ärendekrav i hela organisationen.
...
1. Klicka på **[!UICONTROL Events]** på den mellanliggande panelen för att visa listan över händelsedefinitioner.
   ...
   Från den här sidan kan du [skapa](#create-an-event-definition), [publicera](#publish-an-event-defintion), [redigera](#publish-an-event-defintion) och [ta bort](#delete-an-event-definition) händelsedefinitioner.
...
1. Välj **[!UICONTROL Event types]** som ska användas för händelsedefinitionen.
   ...
   De [händelsetyper](https://experienceleague.adobe.com/sv/docs/experience-platform/xdm/classes/experienceevent#eventType) som du väljer avgör vilka händelser som är tillgängliga som begränsningar för en _Lyssna efter en händelse_-nod i en kontoresa.
