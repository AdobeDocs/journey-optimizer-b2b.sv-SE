...
# Aktivera Marketo Engage-anslutningar för supportåtgärder
...
1. Välj den uppdateringsprincip som används för att tillämpa en åtgärd på en matchande personpost.
   ...
   * **[!UICONTROL Update only the newest matching record]**
   ...
   >[!NOTE]
   >
   >En person/lead fortsätter genom resan oavsett matchning, utom när ett fel inträffar. En reseåtgärd skapar inte en ny personpost i Marketo Engage när det inte finns någon matchande post.
