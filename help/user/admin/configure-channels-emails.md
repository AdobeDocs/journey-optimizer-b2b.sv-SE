...
>[!AVAILABILITY]
>
>Kontakta Adobe Support eller öppna ett supportärende för att aktivera delning av kommunikationsbegränsningar mellan Journey Optimizer B2B edition och en eller flera Marketo Engage-instanser.

>[!BEGINSHADEBOX]

![AEP-behörighetsikon](../../assets/do-not-localize/icon_permissions-outline.svg) Följande [behörigheter krävs för din tilldelade användarroll i Experience Platform](../admin/user-management.md#b2b-product-permissions):

* **[!UICONTROL B2B Channel Configurations]** - `Manage B2B Channels`
* **[!UICONTROL Journey Optimizer Rules]** - `View Frequency Rules` och `Manage Frequency Rules`
...
Alla Marketo Engage-produktionsinstanser har kommunikationsgränser definierade som standard (mer information finns i [Marketo Engage-dokumentationen](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/administration/email-setup/enable-communication-limits){target="_blank"}). Du kan använda separata kommunikationsgränser för Journey Optimizer B2B edition och din Marketo Engage-produktionsförekomst. Om du vill använda begränsningar för delad kommunikation definierar du reglerna i Journey Optimizer B2B edition och utökar delningen av dessa begränsningar till Marketo Munchkin-koderna.
...
Gå till **[!UICONTROL Administration]** > **[!UICONTROL Channels]** om du vill granska eller ange regler för kommunikationsbegränsning. Välj **[!UICONTROL Communication limits]** under _[!UICONTROL Email]_&#x200B;i navigeringspanelen.
