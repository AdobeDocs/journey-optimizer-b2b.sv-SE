...
| `faxPhone.number` | Antal | Faxnummer | Sträng | Faxnummer. |
| `mobilePhone.number` | Antal | Mobiltelefon | Sträng | Det mobiltelefonnummer som är associerat med personen. |
...
| `workPhone.number` | Antal | Telefonnummer | Sträng | Telefonnummer till arbetet. |
...
| `accountOrganization.annualRevenue.amount` | Årlig intäkt | Årlig intäkt | Antal | Organisationens beräknade årsomsättning. |
