...
>[!NOTE]
>
>XDM-fälthantering är tillgänglig för Journey Optimizer B2B edition-miljöer som har etablerats på den [förenklade arkitekturen](../simplified-architecture.md).
