...
I Journey Optimizer B2B Edition-installationen ingår konfiguration av Experience Platform namnutrymmen och scheman som används med B2B-källor. Postman automatiseringsverktyg krävs för att skapa B2B-namnutrymmen och scheman.
...
Granska följande information om den underliggande konfigurationen för de namnutrymmen och scheman som ska användas med B2B-källor. Här finns också information om hur du konfigurerar Postman automatiseringsverktyg, vilket krävs för att generera B2B-namnutrymmen och scheman.
