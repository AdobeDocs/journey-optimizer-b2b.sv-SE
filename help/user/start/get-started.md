...
När en administratör har slutfört [konfigurationsåtgärderna](../setup-ultimate.md) använder du den här informationen för allmän inloggning.
...
1. **Lägg till anpassade och dynamiska e-postmallar**. Utnyttja Journey Optimizer B2B Edition personalisering och dynamiska innehållsfunktioner för att anpassa budskapet till er målgrupp. [Läs mer](../content/email-templates.md)
